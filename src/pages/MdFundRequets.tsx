...
export default function MasterDistributorFundRequests() {
  ...
  // ✅ Decode token and get distributor_id
  useEffect(() => {
      ...
      try {
        ...
        if (res.data.status === "success") {
          const mapped: FundRequest[] = res.data.data.map((item: any) => ({
            request_unique_id: item.requester_unique_id,
                    ...
                    <Table>
                      <TableHeader>
                        <TableRow>
                          ...
                          <TableHead className="text-center">Requester ID</TableHead>
                          <TableHead className="text-center">Requester Name</TableHead>
                          <TableHead className="text-center">Requested Date</TableHead>
