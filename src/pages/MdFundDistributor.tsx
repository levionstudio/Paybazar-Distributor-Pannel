    ...
    const fetchBalance = async () => {
      ...
      try {
        const res = await axios.get(
          `https://server.paybazaar.in/md/wallet/get/balance/${tokenData.data.master_distributor_id}`,
          {
        ...
        <Card className="shadow-md border rounded-xl overflow-hidden">
          <CardHeader className="gradient-primary text-primary-foreground rounded-t-xl">
            ...
            <CardDescription className="text-primary-foreground/80 mt-1">
              Transfer funds to a distributor's wallet using their phone number.
            </CardDescription>
          </CardHeader>
            ...
            {isCheckingAuth ? (
              ...
              >
                <div className="space-y-2">
                  <Label htmlFor="phone_number">Distributor Phone Number</Label>
                  <Input
                    id="phone_number"
                    type="tel"
                    placeholder="Enter distributor's phone number"
